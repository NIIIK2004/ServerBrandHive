...
public class Services {
    ...
    @Pattern(regexp = "^[А-яA-Za-z]{2,100}$", message = "Название услуги должна быть от 2 до 100 символов и содержать только латинские буквы, кириллицу!")
    private String name;
    ...
    @Pattern(regexp = "^[А-яA-Za-z]{2,2000}$", message = "Описание услуги должна быть от 2 до 2000 символов и содержать только латинские буквы, кириллицу!")
